...
const initchapters = [
  {chapter: 1, title: "Nàng không tin Yến Đình lại lừa nàng chuyện lớn đến vậy!", viewed: false},
  ...
  {chapter: 7, title: "Hoá ra ác nhân còn không biết xấu hổ đi cáo trạng trước!", viewed: false},
  {chapter: 8, title: "Phu quân ngươi đâu? sao hắn không đến cứu ngươi?", viewed: false},
  {chapter: 9, title: "Ngươi vừa nói vân cô nương kia tên là gì?", viewed : false},
  {chapter: 10, title: "Sao bây giờ chàng mới đến tìm ta", viewed : false}, 
  {chapter: 11, title: "Hoá ra chỉ có nàng là tự cho mình đúng!", viewed: false},
  {chapter: 12, title: "Hắn cúi người hôn lên môi nàng!", viewed: false},
  {chapter: 13, title: "Ai càng lún sâu vào tình ái thì người ấy không thể làm được gì!", viewed: false},
  {chapter: 14, title: "Giống như nàng đang gấp gáp đòi danh phận!", viewed: false},
  {chapter: 15, title: "Ngoan!", viewed: false},
  {chapter: 16, title: "Nghiêm khắc với nàng là muốn nàng được tốt hơn!", viewed: false},
  {chapter: 17, title: "", viewed: false},
  {chapter: 18, title: "Phó dư!", viewed: false},
  {chapter: 19, title: "Có người không muốn để nàng yên ổn!", viewed: false},
  {chapter: 20, title: "Có phải uy hiếp hay không, quận chúa có thể thử!", viewed: false},
  {chapter: 21, title: "Các nàng không canh chừng nàng cẩn thận, đương nhiên sẽ bị phạt!", viewed: false},
  {chapter: 22, title: "Bùi thừa tư, rốt cuộc chàng xem ta là gì?", viewed: false},
  {chapter: 23, title: "Giam cầm và phong hậu!", viewed: false},
  {chapter: 24, title: "a sẽ không xem chàng quan trọng hơn bản thân mình nữa!", viewed: false},
  {chapter: 25, title: "Ba lời hứa!", viewed: false},
  {chapter: 26, title: "Nàng không tin Yến Đình lại lừa nàng chuyện lớn đến vậy!", viewed: false},
  ...
  {chapter: 32, title: "Hoá ra ác nhân còn không biết xấu hổ đi cáo trạng trước!", viewed: false},
  {chapter: 33, title: "Phu quân ngươi đâu? sao hắn không đến cứu ngươi?", viewed: false},
  {chapter: 34, title: "Ngươi vừa nói vân cô nương kia tên là gì?", viewed : false},
  {chapter: 35, title: "Sao bây giờ chàng mới đến tìm ta", viewed : false}, 
  {chapter: 36, title: "Hoá ra chỉ có nàng là tự cho mình đúng!", viewed: false},
  {chapter: 37, title: "Hắn cúi người hôn lên môi nàng!", viewed: false},
  {chapter: 38, title: "Ai càng lún sâu vào tình ái thì người ấy không thể làm được gì!", viewed: false},
  {chapter: 39, title: "Giống như nàng đang gấp gáp đòi danh phận!", viewed: false},
  {chapter: 40, title: "Ngoan!", viewed: false},
  {chapter: 41, title: "Nghiêm khắc với nàng là muốn nàng được tốt hơn!", viewed: false},
  {chapter: 42, title: "", viewed: false},
  {chapter: 43, title: "Phó dư!", viewed: false},
  {chapter: 44, title: "Có người không muốn để nàng yên ổn!", viewed: false},
  {chapter: 45, title: "Có phải uy hiếp hay không, quận chúa có thể thử!", viewed: false},
  {chapter: 46, title: "Các nàng không canh chừng nàng cẩn thận, đương nhiên sẽ bị phạt!", viewed: false},
  {chapter: 47, title: "Bùi thừa tư, rốt cuộc chàng xem ta là gì?", viewed: false},
  {chapter: 48, title: "Giam cầm và phong hậu!", viewed: false},
  {chapter: 49, title: "a sẽ không xem chàng quan trọng hơn bản thân mình nữa!", viewed: false},
  ...
  return (
    <div className="inline">
        ...
        <div className="flex w-full justify-center">
          ...
          <div className="bookDetail grid-flow-col pt-7 pl-9">
            ...
            <div className="groupDesc pt-6">
              ...
              <ReadMore fullText={book.description} numberOfChapter={chapters.length} />
            </div>
      ...
      <div className="listChapter">
        ...
        <ListChapter className = "" data={chapters} chapterPerPage={7} currentPage={1} clickAction= {handleChapterClick} />
      </div>
    </div>
  );
}
