...
const DownloadedPage = () => {
  ...
  return (
    <div className="bg-main-light p-6">
        ...
        {downloadNovels.length === 0 && <p className="text-center text-[18px] font-bold my-6">Chưa có truyện nào được tải</p>}
        <div className="flex justify-around mx-14 my-6">
          {downloadNovels.map((novel) => (
            ...
            >
              ...
              <div className="h-6">
                <p className="text-[14px] font-bold text-center text-sub">Đã tải {novel.chapters.length} chương</p>
              </div>
            </Link>
          </div>
          ))}
